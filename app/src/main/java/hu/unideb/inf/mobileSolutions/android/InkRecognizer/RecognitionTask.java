    ...
    public Task<String> run() {
        ...
        return recognizer
                ...
                .onSuccessTask(
                        ...
                        SharedPreferences.Editor editor=  DigitalInkMainActivity.sharedpreferences.edit();
                        editor.putString("items",
                               DigitalInkMainActivity.sharedpreferences.getString("items","")+"\n\u2022 " +capitalize(currentResult.text)+"\n");
                        editor.apply();
                            done.set(true);
